    ...
    <div className="home">
      ...
      <h1>The Nomads Workshop<span>
        ...
        <div className="content1">
               ...
               <div className="img1"><img src="https://sdbooth2-production.s3.amazonaws.com/q1w9auu3n30q9othywmjyhomqduf" alt=""></img></div>
        </div>

        {/* content 2 */}
        <div className="content2">
        <img src="https://sdbooth2-production.s3.amazonaws.com/90ixul15hbmbhih3gol4b044lfi7" alt=""></img>
